...
const createPDF = (req) => {
    return new Promise(async (resolve, reject) => {
        ...
        let doc_name, file_path, sample_data, download_path, headerTemplate, footerTemplate;
        switch (doc_type) {
            case 'salary':
                doc_name = "salary_pledge";
            ...
            case 'sanction':
                doc_name = "final_sanction_letter";
